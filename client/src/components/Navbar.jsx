...
function Navbar() {
    return (
        <header className='w-full h-26 mt-4 relative'>
            <nav className='p-2 sm:px-4 max-w-[1400px] w-full mx-auto border-violet-300 border-2 shadow-md rounded-full bg-violet-500/20 flex items-center justify-between sticky top-5'>
